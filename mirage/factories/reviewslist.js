...
export default Factory.extend({
  title: faker.list.cycle('Analyzing patients records','Repeatability and Benefaction in Computer Systems Research','Social Network Analysis using Genetic Algorithms','Reproducible Research for Scientific Computing'),
